...
<script>
    ...
    function getData() {
        var nik = $("#nik").val();
        $.getJSON("{{ route('getemployee') }}", {
            nik: nik
        }, function(json) {
            $('#employee_name').val(json.employee.employee_name);
            $('#birth_date').val(json.employee.birth_date);
            $('#email').val(json.employee.email);
            $('#phone').val(json.employee.phone);
            $('#jabatan').val(json.employee.jabatan);
            $('#efective_date').val(json.employee.efect_date);
        });
    }
    $(function() {
                ...
                preConfirm: (login) => {
                    $.ajax({
                        ...
                        error: function(response) {
                            const myobj = JSON.parse(response.error);
                            Swal.fire({
                                icon: 'error',
                                title: "Error",
                            }); 
